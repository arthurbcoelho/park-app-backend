...
export class CreateVagaOcupada1750261882414 implements MigrationInterface {
    name = 'CreateVagaOcupada1750261882414'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "veiculos" ("id" SERIAL NOT NULL, "modelo" character varying NOT NULL, "placa" character varying NOT NULL, "cor" character varying NOT NULL, "nomeProprietario" character varying NOT NULL, "contatoProprietario" character varying NOT NULL, "marcaId" integer NOT NULL, "marcaNome" character varying NOT NULL, "tipoId" integer NOT NULL, "tipoNome" character varying NOT NULL, CONSTRAINT "PK_0c3daa1e5d16914bd9e7777cf77" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "vagas_ocupadas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "vagaId" uuid NOT NULL, "vagaCodigo" character varying NOT NULL, "veiculoId" integer NOT NULL, "placaVeiculo" character varying NOT NULL, "horaInicio" TIMESTAMP NOT NULL, "horaFim" TIMESTAMP, "precoHora" numeric(10,2) NOT NULL, "precoTotal" numeric(10,2) NOT NULL, "finalizada" boolean NOT NULL DEFAULT false, "precoFixo" numeric(10,2) NOT NULL, CONSTRAINT "REL_6f4de3d01fe357785d847928d4" UNIQUE ("vagaId"), CONSTRAINT "REL_1a5f54ef638076d93808dc6f6a" UNIQUE ("veiculoId"), CONSTRAINT "PK_7f23b9bd7d94748d436ee1dba84" PRIMARY KEY ("id"))`);
